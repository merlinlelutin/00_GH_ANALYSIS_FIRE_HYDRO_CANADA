...
## Date: 2020-07-09
## Author: Francois-Nicolas Robinne
...
# Load data -------------------------------------------------------------
watersheds_wcs <- st_read("02_TRANSFORMED_DATA/NRCAN/WSC_Watersheds_2015.shp")
fires_nfdb <- st_read("01_RAW_DATA/CWFIS/NFDB_poly_20190607.shp")
...
# This part extracts watersheds from WCS shapefile
stns_1980_2019_no_geo <- st_drop_geometry(stns_1980_2019)
ws_1980_2019 <- watersheds_wcs %>%
  inner_join(stns_1980_2019_no_geo, by = c("Station" = "STATION_NUMBER")) # Returns 817 objects (out of the 1765 identified, which means that 948 watersheds are missing)

ggplot() +
  geom_sf(data=ws_1980_2019, col = "red") # Plot selected watersheds for stations that exist between 1980 and 2019 only
